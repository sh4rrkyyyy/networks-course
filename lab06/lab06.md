...
2. Определите длину (в байтах) для каждого поля UDP-заголовка, обращаясь к отображаемой
   ...
   - Каждое из полей имеет длину 2 байта
![err](images/2_1.png)
![err](images/2_2.png)
![err](images/2_3.png)
![err](images/2_4.png)
3. Значение в поле Length (Длина) – это длина чего?
   - общая длина udp datagram'ы в байтах (payload + header)
4. Какое максимальное количество байт может быть включено в полезную нагрузку UDP-пакета?
   - 65535 - 20 - 8 = 65507 (65535 - максимальный размер ip-пакета, 20 - длина ip-заголовка, 8 - длина udp-заголовка)
5. Чему равно максимально возможное значение номера порта отправителя?
   - 65535 (порт занимает 2 байта)
...
7. Проверьте UDP-пакет и ответный UDP-пакет, отправляемый вашим хостом. Определите
   ...
   - у отправляемого с хоста пакета source port 41533, destination port 53, у полученного хостом пакета наоборот: source port 53, destination port 41533
![err](images/1.png)
![err](images/7.png)
...
#### Скрины
![err](images/test-user.png)
![err](images/files.png)
![err](images/delete-file.png)
...
#### Демонстрация работы
![err](images/client1.png)
![err](images/client2.png)
![err](images/client3.png)
