...
1. Какой IP-адрес и номер порта TCP использует ваш компьютер (отправитель), передающий
   ...
   - src: 192.168.0.12, src port: 52302
   ![err](images/1.png)
...
6. Рассмотрите TCP-сегмент, содержащий команду POST протокола HTTP, как первый TCP-сегмент 
   ...
   - 1, 624, 3504, 6384, 9264, 12144 
   - 63.703747350, 63.711344368, 63.711406420, 63.712157154, 63.712176142, 63.712506143
   - 63.830659982, 63.830659982, 63.836579896, 63.837378027, 63.837378088, 63.837378145
   - 0.1269126319, 0.1193156140, 0.1251734760, 0.1252208729, 0.1252019460, 0.1248720020
   ![err](images/6.png)
7. Чему равна пропускная способность (количество байтов, передаваемых в единицу
   ...
   - 90869 байт/с
   - 90869 = 12143 / (63.837378145 - 63.703747350) -- общее количество переданных байт делить на время передачи
