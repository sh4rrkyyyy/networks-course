...
#### Демонстрация работы
![err](images/rust-lang.png)
![err](images/cppref.png)
![err](images/github.png)
![err](images/log1.png)
...
После двух запросов 
```
curl http://localhost:8084/www.rust-lang.org
```
лог выглядит так:
![err](images/log2.png)
т.е. данные взяты из кэша
